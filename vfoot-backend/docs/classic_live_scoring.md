...
**"Previous" quando la rosa è cambiata**: si riusa l'ultima formazione salvata **filtrata sui giocatori ancora in rosa**. I ceduti → slot vuoti (`vacant`) → sostituzione automatica dai panchinari superstiti, e se la panchina non arriva il voto d’ufficio li copre come qualunque altro buco (dal 23/08/2026: prima restavano scoperti, e perdevano anche il cancello del modificatore difesa — doppia penalità per una dimenticanza). I **nuovi acquisti non entrano automaticamente**: la pagina mostra il buco col suo ruolo, da riempire.
