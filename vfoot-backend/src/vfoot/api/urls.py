...
from vfoot.api.league_views import (
    ...
    LeagueBudgetGrantsView,
    LeagueBudgetGrantRevokeView,
    LeagueRosterBulkAssignView,
    LeagueTradeView,
    LeagueTradeCheckView,
...
urlpatterns = [
    ...
    path("leagues/<int:league_id>/budget/grants", LeagueBudgetGrantsView.as_view(),
         name="league-budget-grants"),
    path("leagues/<int:league_id>/budget/grants/<str:batch>/revoke",
         LeagueBudgetGrantRevokeView.as_view(), name="league-budget-grant-revoke"),
    path("leagues/<int:league_id>/trades", LeagueTradeView.as_view(), name="league-trades"),
    path("leagues/<int:league_id>/trades/check", LeagueTradeCheckView.as_view(),
         name="league-trade-check"),
    path(
