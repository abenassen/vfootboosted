                    ...
                    <div className="inline-block min-w-full align-middle">
                        <table className="min-w-full table-auto border-collapse border-spacing-px bg-custom-gray-100 dark:bg-custom-gray-700">
                            <thead className="text-xs/tight font-bold uppercase text-custom-gray-900 dark:text-white">
                                <tr>
                                    <th scope="col" className="py-3.5 pe-4 ps-8 text-start">
                                        # / Team
                                    </th>
                            ...
                            <tbody className="rounded-3xl text-sm/tight font-bold text-custom-gray-900 dark:text-white [&_td]:bg-white dark:[&_td]:bg-custom-gray-800">
                                {standings.map((team, index) => (
                                    ...
                                    >
                                        <td className="whitespace-nowrap py-4 pe-4 ps-8 text-start">
                                            <div className="flex items-center gap-1.5">
                                                ...
                                                <div className="min-w-0 max-w-[150px] flex-1 truncate">{team.name}</div>
                                            </div>
                                        </td>
                                        <td className="whitespace-nowrap px-2.5 py-4 text-center">{team.stats.wins}</td>
                                        <td className="whitespace-nowrap px-2.5 py-4 text-center font-normal text-custom-gray dark:text-custom-gray-400">
                                            {team.stats.losses}
                                        </td>
                                        <td className="whitespace-nowrap px-2.5 py-4 text-center">{team.stats.draws}</td>
                                        <td className="whitespace-nowrap px-2.5 py-4 text-center">{team.stats.points}</td>
