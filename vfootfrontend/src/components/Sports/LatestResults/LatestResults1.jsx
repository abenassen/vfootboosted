            ...
            <div className="rounded-3xl border border-custom-gray-200 bg-white px-8 py-7 dark:border-custom-gray-600 dark:bg-custom-gray-800">
                ...
                <div className="-mx-8 -mb-7 -mt-0.5 overflow-hidden rounded-3xl pt-0.5">
                    {results.map((result) => (
                        ...
                        >
                            <h4 className="px-8 py-4 text-center text-xs/tight font-bold text-custom-gray-900 dark:text-white">{result.title}</h4>
                                            ...
                                            <div key={team.name} className="group flex items-center justify-between even:flex-row-reverse">
                                                <div className="flex items-center gap-1.5 group-even:flex-row-reverse">
                                                    ...
                                                    <div className="min-w-0 text-sm/tight font-bold text-custom-gray-900 dark:text-white">
                                                        <div className="hidden max-w-[120px] truncate sm:inline-block">{team.name}</div>
                                                        <div className="inline-block sm:hidden">{team.abbr}</div>
                                                    </div>
                                                </div>
                                                <div className="relative inline-flex items-center gap-x-2 text-sm/tight font-bold text-custom-gray-900 group-first:after:absolute group-first:after:start-full group-first:after:top-0 group-first:after:translate-x-1/2 group-first:after:content-['-'] dark:text-white">
                                                    {team.outcome === 'win' && (
                                                        <div className="h-0 w-0 border-[5px] border-custom-blue border-y-transparent group-odd:border-e-0 group-even:order-1 group-even:border-s-0"></div>
                                                    )}
                                                    <div>{team.score}</div>
                                                </div>
                                            </div>
