...
export interface ClassicPlayerLine {
  ...
  explanation?: {
    ...
    contributions: {
       ...
       *  risultato, rosso, autogol, rigore sbagliato; e `completion`, il credito
       *  atteso di gol/assist nei minuti non giocati. */
      kind?: string;
    }[];
    base: number;            // where every vote starts: the role centre, rescaled
