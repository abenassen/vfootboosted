...
type ApiImpl = {
  ...
  uploadCrestImage: typeof backendApi.uploadCrestImage;
  crestImageUrl: typeof backendApi.crestImageUrl;
  reportCrestImage: typeof backendApi.reportCrestImage;
  revokeCrestImage: typeof backendApi.revokeCrestImage;
  ...
  getProbableLineups: typeof backendApi.getProbableLineups;
  getNews: typeof backendApi.getNews;
  markNewsSeen: typeof backendApi.markNewsSeen;
...
export const uploadCrestImage = typedImpl.uploadCrestImage;
export const crestImageUrl = typedImpl.crestImageUrl;
export const reportCrestImage = typedImpl.reportCrestImage;
export const revokeCrestImage = typedImpl.revokeCrestImage;
...
export const getProbableLineups = typedImpl.getProbableLineups;
export const getNews = typedImpl.getNews;
export const markNewsSeen = typedImpl.markNewsSeen;
