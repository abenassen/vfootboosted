    ...
    <div className={`rounded-xl bg-surface-2 px-3 py-2 text-[12px] ${flush ? '' : 'mb-2 ml-8'}`}>
      ...
      <div className="space-y-0.5">
        {/* «Voto di partenza» e non piu' «Media del ruolo»: dal 01/09/2026 la base
            ...
            che il giocatore ha aggiunto. La compressione dei voti alti e'
            ripartita in proporzione su tutte le voci (la riga a se', provata
            l'11/09/2026, faceva leggere una doppietta come +2,86 e -1,45). */}
        <div className="flex items-baseline justify-between gap-3 text-ink-faint">
