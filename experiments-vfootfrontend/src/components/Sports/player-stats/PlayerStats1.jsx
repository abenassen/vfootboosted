  ...
  return (
    <div className="mx-auto w-full max-w-[1460px] px-5">
      <div className="rounded-3xl border border-custom-gray-200 bg-team-golden-primary dark:border-custom-gray-600">
        <div className="grid min-h-[340px] gap-y-12 px-6 py-8 md:grid-cols-[35%_1fr_auto] md:gap-x-6 md:py-0 md:ps-0 md:pe-5 lg:gap-x-0">
          ...
          <div className="order-2 grid grid-cols-2 items-baseline gap-x-4 gap-y-4 self-center text-white uppercase sm:grid-cols-4 md:order-none md:grid-cols-1 md:gap-y-1 md:py-12 md:pe-8 lg:grid-cols-2 lg:gap-y-8 xl:pe-14">
            {metrics.map((metric) => (
