...
function InstagramIcon(props) {
  return (
    <svg viewBox="0 0 16 16" aria-hidden="true" {...props}>
      <path d="M11.585 0H4.416C1.981 0 0 1.981 0 4.416V11.586C0 14.02 1.981 16 4.416 16H11.585C14.02 16 16 14.02 16 11.586V4.416C16.001 1.981 14.02 0 11.585 0ZM14.19 11.373C14.19 12.926 12.926 14.191 11.372 14.191H4.628C3.074 14.191 1.81 12.925 1.81 11.373V4.628C1.81 3.073 3.075 1.81 4.628 1.81H11.372C12.927 1.81 14.19 3.074 14.19 4.628V11.373ZM8 4.285C5.952 4.285 4.285 5.953 4.285 8C4.285 10.048 5.952 11.714 8 11.714C10.048 11.714 11.715 10.048 11.715 8C11.716 5.953 10.049 4.285 8 4.285ZM8 10.189C6.792 10.189 5.81 9.207 5.81 8C5.81 6.791 6.792 5.81 8 5.81C9.208 5.81 10.19 6.791 10.19 8C10.19 9.207 9.208 10.189 8 10.189ZM12.105 2.858C11.832 2.858 11.403 2.973 11.192 3.188C10.978 3.4 10.856 3.696 10.856 3.998C10.856 4.299 10.978 4.595 11.192 4.808C11.403 5.021 11.699 5.143 11.999 5.143C12.302 5.143 12.596 5.021 12.809 4.808C13.022 4.595 13.144 4.299 13.144 3.998C13.144 3.696 13.022 3.4 12.809 3.188C12.597 2.973 12.38 2.858 12.105 2.858Z" />
    </svg>
  );
}

export default function PlayerStats3() {
  return (
    <div className="mx-auto w-full max-w-[1460px] px-5">
      <div className="rounded-3xl border border-custom-gray-200 bg-team-golden-secondary dark:border-custom-gray-600">
        <div className="grid min-h-[340px] gap-y-12 px-6 py-8 md:grid-cols-[35%_1fr_auto] md:gap-x-6 md:px-0 md:py-0 xl:gap-x-0">
          <div className="relative order-3 -mx-6 -mt-5 -mb-8 h-[340px] overflow-hidden md:order-none md:mx-0 md:mb-0 md:h-auto">
            <div className="absolute start-1/2 top-1/2 flex h-full -translate-x-1/2 -translate-y-1/2 items-center justify-center text-[320px] font-extrabold tracking-tight text-white italic opacity-20 mix-blend-overlay md:text-[200px] lg:text-[240px] xl:text-[320px]/none">
              26
            </div>
            <img
              src="https://danfisher-bucket-1.s3.us-east-2.amazonaws.com/sportyblocks/player-1.png"
              alt="Player"
              className="absolute start-1/2 top-0 max-w-[360px] -translate-x-1/2 md:max-w-[320px] lg:max-w-[450px]"
            />
            <div className="absolute start-4 top-9 flex flex-col gap-y-2.5 lg:start-10 lg:top-14">
              <div className="inline-flex aspect-square w-10 items-center justify-center rounded-full border border-custom-gray-200 bg-white md:w-10 lg:w-16">
                <svg
                  viewBox="0 0 420 420"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-6 w-6 text-team-golden-primary lg:h-10 lg:w-10"
                >
                  <path
              ...
              <div className="inline-flex aspect-square w-10 items-center justify-center rounded-full border border-custom-gray-200 bg-white md:w-10 lg:w-16">
                <svg viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 rounded-full lg:h-10 lg:w-10">
          ...
          <div className="order-1 mx-auto md:order-none md:mx-0 md:py-12 md:pb-8">
            ...
            <div className="mb-8 flex items-start justify-center gap-1.5 md:mb-10 md:justify-start">
              <span className="inline-flex rounded-full bg-custom-yellow-300 px-3 py-1 text-xs/none font-extrabold tracking-[0.2em] text-custom-gray-900 uppercase">
                Golden Team
              </span>
              <span className="inline-flex items-center gap-x-1.5 rounded-full bg-custom-gray-900 px-3 py-1 text-xs/none font-extrabold tracking-[0.2em] text-white uppercase">
                <span className="aspect-square w-1.5 rounded-full border-2 border-custom-green"></span>
                Active
              </span>
            </div>
            <div className="grid grid-cols-1 gap-y-5 text-white uppercase md:grid-cols-2 md:gap-x-6 lg:gap-x-24 xl:gap-x-32">
              {metrics.map((metric) => (
                <div key={metric.label} className="grid grid-cols-2 gap-x-3 md:grid-cols-1 xl:grid-cols-2">
          ...
          <div className="order-2 px-10 pt-5 md:px-4 lg:px-10 lg:pt-10">
            <div className="mx-auto flex max-w-min items-center justify-center gap-x-4 rounded-full border border-custom-gray-200 bg-white px-7 py-4 md:mx-0">
              <a href="#">
                <XIcon className="h-4 w-4 fill-custom-gray-900" />
              </a>
              <a href="#">
                <TwitchIcon className="h-4 w-4 fill-custom-gray-900" />
              </a>
              <a href="#">
                <InstagramIcon className="h-4 w-4 fill-custom-gray-900" />
              </a>
            </div>
          </div>
        </div>
