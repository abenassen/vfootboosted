  ...
  return (
    <div className="mx-auto w-full sm:w-[340px]">
      <div className="overflow-hidden rounded-3xl border border-custom-gray-200 bg-white dark:border-custom-gray-600 dark:bg-custom-gray-800">
        <div className="rounded-3xl bg-team-emerald-primary pt-[116px]">
          <div className="flex flex-col items-center rounded-3xl bg-white pb-7 ring-1 ring-custom-gray-200 dark:bg-custom-gray-800 dark:ring-custom-gray-600">
            <div className="-mt-[88px] flex aspect-square w-[156px] items-center justify-center rounded-full border-[0.5rem] border-white bg-team-emerald-primary dark:border-custom-gray-600">
              <svg
                viewBox="0 0 420 420"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="h-24 w-24 text-team-emerald-primary [filter:drop-shadow(0_0_10px_rgba(0,0,0,0.3))]"
              >
                <path
            ...
            <div className="flex flex-col items-center gap-1.5 pt-2">
              <div className="text-[1.375rem]/tight font-bold tracking-tight text-custom-gray-900 dark:text-white">Emerald Team</div>
