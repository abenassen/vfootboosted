  ...
  return (
    <div className="mx-auto w-full px-5 sm:w-[500px]">
      <div className="rounded-3xl border border-custom-gray-200 bg-white px-8 py-7 dark:border-custom-gray-600 dark:bg-custom-gray-800">
        ...
        <div className="-mx-8 -mt-0.5 -mb-7 overflow-hidden rounded-3xl pt-0.5">
          {results.map((result) => (
            <div
              key={result.title}
                ...
                {result.events.map((event) => (
                  ...
                  >
                    {event.teams.map((team) => (
                      <div
                        key={team.name}
                        className="group/item flex items-center justify-between even:flex-row-reverse"
                      >
                        <div className="flex items-center gap-1.5 group-even/item:flex-row-reverse">
                          <svg
                            viewBox="0 0 420 420"
                            fill="none"
                          ...
                          <div className="min-w-0 text-sm/tight font-bold text-custom-gray-900 dark:text-white">
                        ...
                        <div className="relative inline-flex items-center gap-x-2 text-sm/tight font-bold text-custom-gray-900 group-first/item:after:absolute group-first/item:after:start-full group-first/item:after:top-0 group-first/item:after:translate-x-1/2 group-first/item:after:content-['-'] dark:text-white">
                          {team.outcome === "win" && (
                            <div className="h-0 w-0 border-[5px] border-custom-blue border-y-transparent group-odd/item:border-e-0 group-even/item:order-1 group-even/item:border-s-0"></div>
                          )}
                          <div>{team.score}</div>
                        </div>
                      </div>
