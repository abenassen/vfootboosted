function VolleyBallField() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 396 580" className="mx-auto aspect-396/580 max-w-full">
      <rect width="396" height="580" fill="url(#paint0_linear_1289_2061)" rx="12"></rect>
      <mask id="path-2-inside-1_1289_2061" fill="#fff">
        <rect width="316" height="500" x="40" y="40" rx="4"></rect>
      </mask>
      <rect
        width="316"
        height="500"
        x="40"
        y="40"
        fill="url(#paint1_linear_1289_2061)"
        stroke="#fff"
        strokeWidth="12"
        mask="url(#path-2-inside-1_1289_2061)"
        rx="4"
      ></rect>
      <mask id="mask0_1289_2061" style={{ maskType: 'alpha' }} width="396" height="580" x="0" y="0" maskUnits="userSpaceOnUse">
        <rect width="396" height="580" fill="url(#paint2_linear_1289_2061)" rx="12"></rect>
      </mask>
      <g mask="url(#mask0_1289_2061)" className="mix-blend-overlay">
        <path
          fill="#000"
          fillRule="evenodd"
          d="M488-7v18H-92V-7h580zm0 36v18H-92V29h580zm0 54V65H-92v18h580zm0 18v18H-92v-18h580zm0 54v-18H-92v18h580zm0 18v18H-92v-18h580zm0 54v-18H-92v18h580zm0 18v18H-92v-18h580zm0 54v-18H-92v18h580zm0 18v18H-92v-18h580zm0 54v-18H-92v18h580zm0 18v18H-92v-18h580zm0 54v-18H-92v18h580zm0 18v18H-92v-18h580zm0 54v-18H-92v18h580zm0 18v18H-92v-18h580zm0 54v-18H-92v18h580z"
          clipRule="evenodd"
          opacity="0.2"
        ></path>
      </g>
      <path
        fill="#fff"
        d="M350 36h6v-6h-6v6zM46 36h-6v-6h6v6zM40 207h316v-6H40v6zM40 287h316v6H40v-6zM40 373h316v6H40v-6zM36 373h-6v6h6v-6zM20 373h6v6h-6v-6zM16 373h-6v6h6v-6zM380 373h6v6h-6v-6zM376 373h-6v6h6v-6zM360 373h6v6h-6v-6zM356 544h-6v6h6v-6zM40 544h6v6h-6v-6zM366 207h-6v-6h6v6zM370 207h6v-6h-6v6zM386 207h-6v-6h6v6zM10 207h6v-6h-6v6zM26 207h-6v-6h6v6zM30 207h6v-6h-6v6z"
      ></path>
      <path className="mix-blend-overlay" fill="#000" d="M350 293H430V597H350z" opacity="0.4" transform="rotate(90 350 293)"></path>
      <path className="mix-blend-overlay" fill="#000" d="M350 207H430V511H350z" opacity="0.4" transform="rotate(90 350 207)"></path>
      <defs>
        <linearGradient id="paint0_linear_1289_2061" x1="198" x2="198" y1="0" y2="580" gradientUnits="userSpaceOnUse">
          <stop stopColor="#5956E9"></stop>
          <stop offset="1" stopColor="#7B78FF"></stop>
        </linearGradient>
        <linearGradient id="paint1_linear_1289_2061" x1="198" x2="198" y1="40" y2="540" gradientUnits="userSpaceOnUse">
          <stop stopColor="#FC4B13"></stop>
          <stop offset="1" stopColor="#FF8F6B"></stop>
        </linearGradient>
        <linearGradient id="paint2_linear_1289_2061" x1="198" x2="198" y1="0" y2="580" gradientUnits="userSpaceOnUse">
...
function PlayerCard({ name, image, number, className = '' }) {
  return (
    <div className={`absolute z-10 flex flex-col items-center gap-[1cqi] ${className}`}>
      <figure className="relative isolate flex aspect-square w-[12.6cqi] items-center justify-center rounded-full bg-linear-to-b from-custom-green-500 to-custom-green-200">
        <div className="mx-auto flex aspect-square w-[84%] justify-center overflow-hidden rounded-full bg-custom-gray-900">
          <img src={image} alt={name} className="w-[18cqi] max-w-none shrink-0 object-cover object-top" />
        </div>
        <svg
          viewBox="0 0 420 420"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
          className="absolute end-0 top-0 h-[4.5cqi] w-[4.5cqi] text-team-emerald-primary"
        >
          <path
      ...
      <div className="flex justify-center text-[2.6cqi]/tight font-extrabold text-white uppercase">
        <div className="bg-team-emerald-primary px-[0.8em] py-[0.3em] [text-shadow:_0_0_0.6em_rgb(0_0_0_/_40%)]">{number}</div>
        <div className="max-w-fit truncate bg-custom-gray-900 px-[0.8em] py-[0.3em]">{name}</div>
      </div>
    </div>
  );
}

export default function TeamTactic5() {
  return (
    <div className="mx-auto w-full sm:w-[460px]">
      <div className="rounded-3xl border border-custom-gray-200 bg-white px-8 py-7 dark:border-custom-gray-600 dark:bg-custom-gray-800">
        <div className="relative -mx-8 -mt-7 px-8 py-7">
          <h3 className="pe-10 text-base/tight font-bold text-custom-gray-900 dark:text-white">Team’s Tactic V5</h3>
        ...
        <div className="-mx-8 overflow-hidden rounded-t-3xl">
          <div className="bg-[#FC511B] px-8 pt-4 pb-10">
            <h4 className="text-xs/tight font-bold text-white uppercase">Formation: 4 - 2</h4>
          </div>
