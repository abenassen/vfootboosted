...
export default function TeamStats2() {
  return (
    <div className="mx-auto w-full max-w-[1460px] px-5">
      <div className="@container overflow-hidden rounded-3xl border border-custom-gray-200 bg-team-emerald-primary dark:border-custom-gray-600">
        <div className="relative h-48 w-full @xl:h-52 @2xl:h-60">
          <div className="absolute start-1/2 -bottom-8 flex aspect-square w-[156px] -translate-x-1/2 items-center justify-center rounded-full border-[0.5rem] border-white bg-team-emerald-primary @2xl:w-[190px] dark:border-custom-gray-800">
            <svg
              viewBox="0 0 420 420"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              className="h-24 w-24 text-team-emerald-primary [filter:drop-shadow(0_0_10px_rgba(0,0,0,0.3))] @2xl:h-[120px] @2xl:w-[120px]"
            >
              <path
          ...
          <div className="absolute end-4 top-4 flex gap-2 @2xl:end-10 @2xl:top-10">
            ...
            <div className="inline-flex aspect-square w-10 items-center justify-center rounded-full border border-custom-gray-200 bg-white @2xl:w-12 dark:border-custom-gray-600 dark:bg-custom-gray-800">
              <svg viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 rounded-full @2xl:h-8 @2xl:w-8">
        ...
        <div className="rounded-3xl bg-white py-9 ring-1 ring-custom-gray-200 dark:bg-custom-gray-800 dark:ring-custom-gray-600">
          <div className="grid gap-y-6 @xl:grid-cols-2 @3xl:grid-cols-3">
            ...
            <div className="order-1 flex flex-col items-center gap-0.5 @xl:order-1 @xl:col-span-2 @3xl:col-span-1">
              ...
              <div className="rounded-full bg-custom-green-300 px-3 py-0.5 text-3xs/snug font-extrabold tracking-[0.3em] text-custom-gray-900 uppercase">
                Boston
              </div>
            </div>
