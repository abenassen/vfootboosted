      ...
      <div className="@container relative isolate overflow-hidden rounded-3xl border border-custom-gray-200 bg-team-blue-400 dark:border-custom-gray-600">
        <div className="relative flex h-36 w-full items-center @xl:h-44 @2xl:h-[340px]">
          <div className="flex flex-wrap items-center gap-3 ps-6 @2xl:gap-8 @2xl:ps-14">
            <div className="relative h-20 w-20 shrink-0 @2xl:h-52 @2xl:w-52 @3xl:h-56 @3xl:w-56 @4xl:h-64 @4xl:w-64">
              <svg
                viewBox="0 0 420 420"
                fill="none"
            ...
            <div className="flex flex-col gap-1 @2xl:gap-3">
              ...
              <div className="max-w-fit rounded-full bg-team-aqua-300 px-3 py-0.5 text-3xs/snug font-extrabold tracking-[0.3em] text-custom-gray-900 uppercase">
                Washington
              </div>
            </div>
          </div>
        </div>
        <div className="absolute inset-y-0 end-0 -z-20 hidden w-1/3 bg-team-blue-500 [clip-path:polygon(25%_0,100%_0,100%_100%,0_100%)] @xl:block"></div>
        <div className="rounded-3xl bg-white py-9 ring-1 ring-custom-gray-200 dark:bg-custom-gray-800 dark:ring-custom-gray-600">
          <div className="grid grid-cols-2 gap-y-6 text-slate-800 @md:grid-cols-3 @4xl:grid-cols-6 @4xl:divide-x @4xl:divide-custom-gray-200 dark:text-white @xl:dark:border-custom-gray-600 @4xl:dark:divide-custom-gray-600">
            ...
            <div className="flex flex-col items-center gap-3 px-7 text-center">
              <svg viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 rounded-full @3xl:h-8 @3xl:w-8">
              ...
              <div className="text-[0.6875rem]/tight uppercase">Nationality</div>
            </div>
