...
export default function TeamLineup2() {
  return (
    <div className="mx-auto w-full sm:w-[460px]">
      <div className="rounded-3xl border border-custom-gray-200 bg-white px-8 py-7 dark:border-custom-gray-600 dark:bg-custom-gray-800">
        <div className="relative -mx-8 -mt-7 px-8 py-7">
          <h3 className="pe-10 text-base/tight font-bold text-custom-gray-900 dark:text-white">Team Lineup V2</h3>
        ...
        <div className="-mx-8 -mb-7 overflow-x-auto rounded-3xl bg-white ring-1 ring-custom-gray-200 dark:bg-custom-gray-800 dark:ring-custom-gray-600">
          <div className="grid grid-cols-[auto_auto_1fr_auto] gap-x-2.5">
            {/* Heading */}
            <div className="col-span-full -mb-6 grid grid-cols-subgrid bg-custom-gray-100 pb-6 text-xs/tight font-bold text-custom-gray-900 uppercase dark:bg-custom-gray-700 dark:text-white">
              ...
              <div className="py-4 ps-4 pe-8 text-end"></div>
            </div>
            {/* Heading / End */}
                  ...
                  >
                    ...
                    <div className="py-2.5">
                      <div className="flex min-w-[12rem] items-center gap-2.5">
                        <figure className="flex aspect-square w-6 shrink-0 justify-center overflow-hidden rounded-full border border-custom-gray-200 bg-custom-gray-100 dark:border-custom-gray-600 dark:bg-custom-gray-700">
                          {player.img ? (
                            <img src={player.img} alt={player.name} className="h-auto w-10 max-w-none object-cover object-top" />
                          ) : (
                            <>
                              <img
                                src="https://danfisher-bucket-1.s3.us-east-2.amazonaws.com/sportyblocks/player-placeholder.png"
                                alt={player.name}
                                className="h-auto w-10 max-w-none object-cover object-top dark:hidden"
                              />
                              <img
                                src="https://danfisher-bucket-1.s3.us-east-2.amazonaws.com/sportyblocks/player-placeholder-white.png"
                                alt={player.name}
                                className="hidden h-auto w-10 max-w-none object-cover object-top dark:block"
                              />
                            </>
                          )}
                        </figure>
                    ...
                    <div className="flex justify-end gap-1.5 py-3 ps-4 pe-8 text-end">
