    ...
    players: [
      {
        ...
        player2: {
          ...
          position: 'Goalkeeper',
          name: 'Sandra Yoshida',
          img: 'https://danfisher-bucket-1.s3.us-east-2.amazonaws.com/sportyblocks/player-8.png',
          mins: 90,
        },
      },
      {
        ...
        player2: {
          ...
          img: 'https://danfisher-bucket-1.s3.us-east-2.amazonaws.com/sportyblocks/player-6.png',
          actions: [
            {
              type: 'yellow-card',
            },
      ...
      },
      {
        ...
        player2: {
          ...
          position: 'Midfielder',
          name: 'Jean Summers',
          img: 'https://danfisher-bucket-1.s3.us-east-2.amazonaws.com/sportyblocks/player-4.png',
          actions: [
            {
              type: 'sub-out',
            },
      ...
      },
      {
        ...
        player2: {
          number: '07',
          position: 'Midfielder',
          name: 'Emmanuelle Grey',
          img: 'https://danfisher-bucket-1.s3.us-east-2.amazonaws.com/sportyblocks/player-5.png',
          mins: 90,
        },
      },
      {
    ...
    players: [
      {
        ...
        player2: {
          ...
          position: 'Defensive',
          name: 'Jass Braddock',
          img: 'https://danfisher-bucket-1.s3.us-east-2.amazonaws.com/sportyblocks/player-9.png',
          actions: [
            {
              type: 'sub-in',
            },
      ...
      },
      {
        ...
        player2: {
          ...
          position: 'Midfielder',
          name: 'Lizzy Dane',
          img: 'https://danfisher-bucket-1.s3.us-east-2.amazonaws.com/sportyblocks/player-14.png',
          mins: 0,
        },
      },
      {
...
export default function TeamLineup5() {
  return (
    <div className="mx-auto w-full xl:w-[1060px]">
      <div className="rounded-3xl border border-custom-gray-200 bg-white px-8 py-7 dark:border-custom-gray-600 dark:bg-custom-gray-800">
        <div className="relative -mx-8 -mt-7 px-8 py-7">
          <h3 className="px-14 pe-10 text-center text-base/tight font-bold text-custom-gray-900 dark:text-white">Team Lineup V5</h3>
          <div className="absolute start-0 top-0 flex h-14 w-14 items-center justify-center rounded-ss-3xl rounded-ee-3xl border-e border-b border-custom-gray-200 bg-white dark:border-custom-gray-600 dark:bg-custom-gray-800">
        ...
        <div className="-mx-8 -mb-7 overflow-x-auto rounded-3xl bg-white ring-1 ring-custom-gray-200 dark:bg-custom-gray-800 dark:ring-custom-gray-600">
          <div className="grid grid-cols-[auto_1fr_auto_auto_auto_auto_1fr_auto] gap-x-2.5">
            {/* Heading */}
            <div className="col-span-full -mb-6 grid grid-cols-subgrid bg-custom-gray-100 pb-6 text-xs/tight font-bold text-custom-gray-900 uppercase dark:bg-custom-gray-700 dark:text-white">
              ...
              <div className="py-4 text-end">Actions</div>
              <div className="py-4 ps-4 pe-8 text-end">Mins</div>
              <div className="py-4 ps-8 pe-4">Mins</div>
              <div className="py-4">Actions</div>
              <div className="py-4 text-end">Player and Position</div>
              <div className="py-4 ps-2.5 pe-8 text-end">#</div>
            </div>
            {/* Heading / End */}
                ...
                {group.players.map((playerGroup) => (
                  ...
                  >
                    <div className="col-span-full grid grid-cols-subgrid items-center">
                      <div className="py-5 ps-8 pe-2.5 text-custom-gray dark:text-custom-gray-400">{playerGroup.player1.number}</div>
                      ...
                      <div>
                        <div className="flex min-w-[12rem] items-center gap-0.5">
                          <figure className="relative isolate flex h-14 w-20 shrink-0 justify-center overflow-hidden">
                            {playerGroup.player1.img ? (
                              <img
                                src={playerGroup.player1.img}
                                alt={playerGroup.player1.name}
                                className="mt-0.5 w-24 max-w-none object-cover object-top"
                              />
                            ) : (
                              <>
                                <img
                          ...
                          <div>
                            <div className="font-bold">{playerGroup.player1.name}</div>
                            <div className="text-xs/tight font-normal">{playerGroup.player1.position}</div>
                          </div>
                        </div>
                      </div>
                      <div className="flex justify-end gap-1.5 py-3 ps-4 text-end">
                        {playerGroup.player1.actions &&
                          playerGroup.player1.actions.map((action) => <LineupIcon key={action.type} type={action.type} />)}
                      </div>
                      <div className="pe-8 text-end font-bold">{playerGroup.player1.mins}’</div>
                      <div className="ps-8 font-bold">{playerGroup.player2.mins}’</div>
                      <div className="flex gap-1.5 py-3 pe-4">
                        {playerGroup.player2.actions &&
                          playerGroup.player2.actions.map((action) => <LineupIcon key={action.type} type={action.type} />)}
                      </div>
                      <div>
                        <div className="flex min-w-[12rem] items-center justify-end gap-0.5">
                          <div className="text-end">
                            <div className="font-bold">{playerGroup.player2.name}</div>
                            <div className="text-xs/tight font-normal">{playerGroup.player2.position}</div>
                          </div>
                          <figure className="relative isolate flex h-14 w-20 shrink-0 justify-center overflow-hidden">
                            {playerGroup.player2.img ? (
                              <img
                                src={playerGroup.player2.img}
                                alt={playerGroup.player2.name}
                                className="mt-0.5 w-24 max-w-none object-cover object-top"
                              />
                            ) : (
                              <>
                            ...
                            <div className="absolute inset-y-0 end-0 -z-10 w-14 bg-team-emerald-primary [clip-path:polygon(24%_0,100%_0,74%_100%,0_100%)]"></div>
                          </figure>
                        </div>
                      </div>
                      <div className="py-5 ps-2.5 pe-8 text-custom-gray dark:text-custom-gray-400">{playerGroup.player2.number}</div>
                    </div>
                  </div>
                ))}
                {/* Players / End */}
